...
extern u16 ZUOBIAO_X[240];
extern u16 ZUOBIAO_Y[320];
extern u16 xi;
extern u16 yi;
//JTAG模式设置定义
...
extern struct zuobiao zuobiao1;
...
void LCD_ShowDec(u16 x,u16 y,float num,u8 size);//显示一个小数;
...
u16  jieceng(u16 jie);
void LCD_float(u8 x1,u8 y1,u8 sum_int,u8 sum_float,const float data);
